...
export async function getMessageAfter(req, res) {
    ...
    try {
        ...
        return res.status(403).json({
            error: "either login or you are not a member of the group you want messages of ",
        });
    }
}
...
export async function getAllMessageAfter(req, res) {
    try {
